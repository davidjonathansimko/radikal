...
export default function TextToSpeech({
  ...
  // Pasul 0409g — VITEZA CITIRII, valoarea de pornire.
  // Schimb-o aici daca vrei alta: 0.9 mai rar, 1.2 mai iute.
  // Butonul de viteza din player trece prin 0.9 → 1.0 → 1.2 → 1.5.
