...
// Pasul 2708002 — textul paginii sta aici, ca sa poata fi schimbat din
// Setari -> Pagini. Ce e scris aici ramane copia de siguranta.
const translations = {
  de: {
    ...
    successText: 'Vielen Dank für deine Nachricht. Ich werde dir bald antworten!',
    nameLabel: 'Name',
  ...
  en: {
    ...
    successText: 'Thank you for your message. I will respond to you soon!',
    nameLabel: 'Name',
  ...
  ro: {
    ...
    title: 'Contact',
    subtitle: '',
    formTitle: 'Trimite Mesaj',
    successTitle: 'Trimis cu succes!',
    successText: 'Mulțumesc pentru mesajul tău. Îți voi răspunde curând!',
    nameLabel: 'Nume',
  ...
  ru: {
    ...
    successText: 'Спасибо за ваше сообщение. Я скоро отвечу!',
    nameLabel: 'Имя',
...
registerPageDefaults('contact', translations);
...
export default function ContactPage() {
  ...
  const t = usePageText('contact', translations, language);
                ...
                */}
                {user && (
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-black/60 dark:text-white/60 text-sm">{t.emailRow}</p>
                      <a 
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-black/60 dark:text-white/60 text-sm">{t.responseTimeLabel}</p>
                    <p className="text-black dark:text-white">{t.responseTimeValue}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-black/60 dark:text-white/60 text-sm">{t.locationLabel}</p>
                    <p className="text-black dark:text-white">{t.locationValue}</p>
                  </div>
                </div>
              </div>
            </div>
